export const environment = {
    ...
    backend: {
      endpoints:{
        ...
        savePasswordUrl:  "https://smartwork-dev-backend-user.idi.ntnu.no/login/app_credentials", //development server
        //savePasswordUrl:  "https://smartwork-prod-backend-user.idi.ntnu.no/login/app_credentials", //production server
        
        validateTokenUrl: "https://smartwork-dev-backend-user.idi.ntnu.no/login/validate_token"   //development server
